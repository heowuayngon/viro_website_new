...
<div class="wrapper">
	...
	<div class="main">
        ...
        <div class="section" id="introduce-category">
            <div class="container">
                <div class="col-lg-4">
                    <img src="assets/img/appscreen.png" alt="" class="img-responsive" />
                </div>
                <div class="col-lg-8">
                    <div class="introduce-category-content">
                        <div class="item">
                            <h2>1.NEWS</h2>
                            <p>We provides you with the latest in daily news, corporate news, SME news, medical 
                                news, pharmaceutical news, logistic news and celebrity news direct posted from 
                                viroapp users.  <br>
                                You can post and share your company’s news in our news categories.
                            </p>
                        </div>
                        <div class="item">
                            <h2>2.EVENTS</h2>
                            <p>Discover popular local banking, finance, crowdfunding, charity, donation, concerts, musical, golf, sports, workshops and seminar event.
                                <br>You can post and share your events in our event categories.
                            </p>
                        </div>
                        <div class="item">
                            <h2>3.PROMO</h2>
                            <p>Search for all the latest promotion from celebrities, retail outlets, shopping mall, food 
                                & beverages, halal products & services, pub & bars, and universities courses.<br> 
                                You can post and share your promotions in our promo categories. 

                            </p>
                        </div>
                        <div class="item">
                            <h2>4.SERVICES</h2>
                            <p>You can engage professional services from celebrities, models, and pet experts.   You 
                                can search also nearby tuition tutor, office rental and home for rent.  
                                You can post and share your professional services in our service categories.    
